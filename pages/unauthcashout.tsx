  ...
  <div  className={styles.photos}>
      <div className={styles.photos}>
             <div>
                     ...
                     <div>
                              <div>
                               <span > <strong>Items To Deliver:4</strong></span>
                              </div>
                              ...
                              <div className={styles.photos}>
                                      ...
                                      <button className={styles.button}> <span className={styles.main1} >Back To Cart</span>  </button>
                      </div>
             </div>
                             ...
                             <div>
                                    ...
                                    <div>
                                        <input type='tel' id ='phone' placeholder="Security Code"/>
                                             ...
                                             <br></br>
                                 <div>
                                     <h2>You Need To <span className={styles.tex}>Sign In</span> And Add Address </h2>
                                 </div>   
         </div>
     </div>
  </div>
