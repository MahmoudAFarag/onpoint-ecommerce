      ...
      <form onSubmit={handleSubmit}>
        <fieldset>
          ...
          <div className='flex flex-col gap-3.5 md:gap-2.5'>
            <Input type='text' label='name' placeholder='Name' value={name} change={setName} autoComplete='signup-fullname' />

            <Input type='email' label='email' placeholder='Email' value={email} change={setEmail} autoComplete='signup-email' />
