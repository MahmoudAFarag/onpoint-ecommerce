      ...
      <form className="pb-4">
        <div className="flex pb-4  ">
          <div className="flex flex-col">
            ...
            <input
              ...
              name="name"
              placeholder="Title"
              className="resize rounded-md bg-slate-400"
            />
          </div>
          <div className="flex flex-col pl-5 pb-4 ">
            ...
            <div className="flex ">
              <input
                ...
                className="resize rounded-md bg-slate-400 "
              />
              <h4 className="resize rounded-md bg-slate-900 pl-1 pr-1 text-white ">
                $
              </h4>
            </div>
          </div>
        ...
        <div className="flex flex-col pb-4">
          ...
          <textarea
            ...
            className="w-1/3 resize rounded-md bg-slate-400"
          />
        </div>
        <div className="flex flex-col pb-4">
